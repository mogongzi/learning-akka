...
public class AssignActorsToDispatcherTest {
    ...
    @Test
    public void shouldReadFilesWithActorsInAnotherDispatcher() throws ExecutionException, InterruptedException {
        ...
        System.out.println("AssignActorsToDispatcherTest took: " + elapsedTime);
    }
}
