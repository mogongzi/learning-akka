...
public class BalancingPoolTest {
    ...
    @Test
    public void shouldReadFilesWithBalancingPool() throws ExecutionException, InterruptedException {
        ActorRef workerRouter = system.actorOf(new BalancingPool(8).props(Props.create(ArticleParseActor.class)), "balancing-pool-router");
